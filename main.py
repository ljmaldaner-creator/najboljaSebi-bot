...
ZADACI = [
    ...
    "Dan 16 - Autoritativna Ja\n\nZamisli sebe kako donosim tešku odluku bez ijednog grama krivice. Kakav je to osecaj?",
    "Dan 17 - Ekonomija energije\n\nKako bi trosila svoju snagu da ne moras nikome da se pravdas?",
    "Dan 18 - Kulturni kapital\n\nSta bi sve mogla da postigneh da tvoja unutrasnja vrednost nije vezana za to koliko si korisna drugima?",
    ...
    "Dan 26 - Duboki uzrok\n\nDa li si spremna da prstanem da lecim simptome i udjem u srz svog skripta?",
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_id not in data["korisnici"]:
        ...
        await update.message.reply_text(
            "Dobrodosla u 30-dnevni izazov!\n\nSvako jutro u 7:30 dobijas novi zadatak koji te vodi dublje u sebe.\n\nPripremi se - pocinjemo sutra."
        )
    else:
